...
public class BlackjackRuntime {
	...
	public static void main(String[] args) {
        ...
        GenerationalEvolutionEngine<BlackjackStrategy> engine = new GenerationalEvolutionEngine<BlackjackStrategy>(
        		...
        		pipeline,
                new BlackjackStrategyFitnessFunction(5000000),	// This is the number of hands played to find the fitness function. Higher number = more accurate fitness!
